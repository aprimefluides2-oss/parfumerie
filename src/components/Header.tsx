...
export default function Header({
  ...
  // Drawer rendu via portal hors du header pour éviter que le `backdrop-blur`
  // du header ne casse le positionnement fixed (les filtres CSS contiennent
  // les positions fixed des descendants).
  const drawer = (
    <AnimatePresence>
      {mobileMenuOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 left-0 z-[101] w-4/5 max-w-sm bg-[#050505] border-r border-white/10 shadow-2xl p-6 md:hidden flex flex-col justify-between overflow-y-auto"
          ...
          >
            ...
            <div className="border-t border-white/10 pt-6 space-y-3">
              <a
                href="/admin"
                className="flex items-center gap-2 text-xs tracking-widest text-[#a1a1a1] hover:text-[#b8860b] uppercase py-2"
              >
  ...
  return (
    <>
      ...
      {/* Mobile drawer rendu via portal pour échapper au filter context du header */}
