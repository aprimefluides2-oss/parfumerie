export const SEED_PERFUMES = [
  {
    ...
    "topNotes": [
      "Bergamote dorée",
      "Amande amère",
      "Fleur de pêcher de Grasse"
    ],
    "heartNotes": [
      "Jasmin Sambac noble",
      "Rose Centifolia Royale",
      "Fleur d'oranger"
    ],
    "baseNotes": [
      "Ambre liquide",
      "Vanille de Madagascar",
      "Héliotrope chaleureux",
      "Santal de Mysore"
    ],
    "image": "/images/perfume_gold_1779660881863.png",
    "colorTheme": {
      "bg": "bg-amber-500",
      "text": "text-amber-900",
      "accent": "#D4AF37",
  ...
  },
  {
    ...
    "topNotes": [
      "Mandarine verte d'Italie",
      "Zeste d'orange douce",
      "Baies de poivre rose"
    ],
    "heartNotes": [
      "Rose de mai sauvage",
      "Pivoine de Granville",
      "Iris de Florence"
    ],
    "baseNotes": [
      "Voile de Musc blanc",
    ...
    "image": "/images/perfume_rose_1779660918617.png",
    "colorTheme": {
      "bg": "bg-rose-400",
      "text": "text-rose-900",
      "accent": "#E0A899",
  ...
  },
  {
    ...
    "season": "Toutes saisons",
    "topNotes": [
      "Bergamote de Calabre sauvage",
      "Poivre noir du Sichuan",
      "Écorce de pamplemousse"
    ],
    "heartNotes": [
      "Lavande de Haute-Provence",
      "Vétiver de Haïti fumé",
      "Patchouli d'Indonésie"
    ],
    "baseNotes": [
      "Ambre gris de rivage",
      "Ciste Labdanum sauvage",
      "Cuir de Russie",
      "Cèdre de Virginie"
    ],
    "image": "/images/perfume_midnight_1779660900238.png",
    "colorTheme": {
      "bg": "bg-slate-700",
      "text": "text-slate-900",
      "accent": "#2C3E50",
  ...
  },
  {
    ...
    "topNotes": [
      "Safran de Perse sacré",
      "Cardamome verte",
      "Note de thé fumé Lapsang"
    ],
    "heartNotes": [
      "Encens sacré d'Oman",
      "Rose de Damas caramélisée",
      "Absolu Oud d'Assam"
    ],
    "baseNotes": [
      "Vanille noire cuirée",
      "Baume de Tolu doux",
      "Bois de Santal lacté",
      "Ambre sec"
    ],
    "image": "/images/perfume_amber_1779660938970.png",
    "colorTheme": {
      "bg": "bg-[#8E5132]",
      "text": "text-amber-950",
      "accent": "#B85C2A",
...
export const SEED_LAYERING = [
  {
    "id": "note_rose",
    "name": "Absolu de Rose",
    "category": "cœur",
    "description": "Un cœur charnel de pétales de rose de Damas veloutés.",
    "intensity": 4
  },
  {
    "id": "note_jasmin",
    ...
    "category": "cœur",
    "description": "Une nuance solaire, florale opulente d'un blanc crémeux.",
    "intensity": 5
  },
  {
    "id": "note_bergamote",
    ...
    "category": "tête",
    "description": "Une envolée pétillante, zestée, fraîche de l'Italie du sud.",
    "intensity": 3
  },
  {
    "id": "note_mandarine",
    ...
    "category": "tête",
    "description": "Une brise fruitée, vibrante, douce et addictive.",
    "intensity": 2
  },
  {
    "id": "note_oud",
    "name": "Bois de Oud Fumé",
    "category": "fond",
    "description": "Une profondeur sombre, boisée sacrée d'or noir d'Assam.",
    "intensity": 5
  },
  {
    "id": "note_santal",
    "name": "Santal crémeux",
    "category": "fond",
    "description": "Une texture lactée, boisée douce et souveraine.",
    "intensity": 3
  },
  {
    "id": "note_vanille",
    "name": "Gousse de Vanille Noire",
    "category": "fond",
    "description": "Une essence suave, cuirée et noble de Bourbon.",
    "intensity": 4
  },
  {
    "id": "note_ambre",
    "name": "Ambre Chaud",
    "category": "fond",
    "description": "Un souffle de résines dorées, sensuel et poudré.",
    "intensity": 4
  }
];
